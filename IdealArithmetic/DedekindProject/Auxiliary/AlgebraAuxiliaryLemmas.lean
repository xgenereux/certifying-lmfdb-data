...
lemma discr_eq_discr_fraction_field_powerBasis {R Q K : Type*} {n : ℕ} [NeZero n] [CommRing R]
  ...
  erw [IsAdjoinRootMonic.basis_apply, IsAdjoinRootMonic.basis_apply, map_pow,
    IsAdjoinRoot.algEquiv_root, SubmonoidClass.coe_pow, Algebra.adjoin_isAdjoinRoot_root]
  rfl
